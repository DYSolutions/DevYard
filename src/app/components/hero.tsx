...
export default function Hero() {
    return (
        <div
            className="flex flex-row w-full h-[100vh] bg-cover bg-center z-[3] mediaHero"
        // style={{ backgroundImage: "url('/main.svg')" }}
        >
            <div className="w-full flex flex-col justify-center items-start p-16 gap-7 heroLeftAnimation mediaHeroSub">
                <h1 className="text-6xl text-blue-600 heroHeading mediaHeroHeading"><span className="text-black">We are a </span>visionary development firm...</h1>
                ...
                <div className="flex flex-row items-center align-middle justify-center w-full mediaEmailInput">
            ...
            <div className="w-full flex justify-center items-center heroRightAnimation mt-10 mediaReorder">
